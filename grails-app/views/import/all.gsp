...
<html>
    ...
    <body>
        <div>
            ...
            <!-- End Breadcrumb -->
            <h2 class="heading-medium"Import all</h2>

            <p class="lead">
                Reload all information into the main search index.
            </p>

            <div>
                <button id="start-import" onclick="javascript:loadInfo()" class="btn btn-primary">
            ...
            <r:script>
                function loadInfo(){
                    $.get("${createLink(controller:'import', action:'importAll')}", function( data ) {
                      if(data.success){
